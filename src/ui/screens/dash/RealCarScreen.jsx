  ...
  return (
    ...
    >
      ...
      <ExpandableInfo title="What the tables are called on real software">
        ...
        <br /><br /><b className={styles.em}>Spark</b> — <i>Ignition timing</i>, <i>Spark advance</i>, or <i>Base spark</i>, usually with separate <i>knock retard</i> and <i>intake-air-temperature correction</i> tables layered on top. This app folds those corrections into one number for clarity; real software separates them.
